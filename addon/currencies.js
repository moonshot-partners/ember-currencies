...
const currenciesObject = Object.keys(currencies).reduce((hash, currency) => {
  const currentCurrency = currencies[currency];

  hash[currentCurrency.iso_code] = {
    name: currentCurrency.name,
    acronym: currentCurrency.iso_code,
    symbol: currentCurrency.symbol,
    digitSeparator: currentCurrency.thousands_separator,
    decimalSeparator: currentCurrency.decimal_mark,
    currencyPlacement: currentCurrency.format ? 'S' : 'P',
    smallestUnitRatio: currentCurrency.subunit_to_unit
  };

  return hash;
}, {});
const currenciesArray = Object.keys(currenciesObject).map(function(k) { return currenciesObject[k]; });
